* create a temp map for useable temp units
* create an alias map for each module
* finish the volume module
* write convert.go module to abstract the alias conversions
